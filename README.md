...
| ------------- | ------------- |------------- |------------- |------------- |------------- |
| Definition  | narrative form  |spelling (normalised or historical) | mode of data capture |[token](https://distantreading.github.io/Schema/eltec-1.html#TEI.teidata.word) count |[size category](https://distantreading.github.io/Schema/eltec-1.html#TEI.size) following the scheme of ELTeC  |
